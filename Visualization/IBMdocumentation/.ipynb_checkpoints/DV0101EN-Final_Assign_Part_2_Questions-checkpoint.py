...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            html.Div(className='chart-item', children=[dbc.Row([dbc.Col(html.Div(children=R_chart1),width={'size':10}),dbc.Col(html.Div(children=R_chart2),width={'size':10})])],style={'display': 'flex'}),
            html.Div(className='chart-item', children=[dbc.Row([dbc.Col(html.Div(children=R_chart3),width={'size':10}),dbc.Col(html.Div(children=R_chart4),width={'size':10})])],style={'display': 'flex'})
                ]
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
            html.Div(className='chart-item', children=[dbc.Row([dbc.Col(html.Div(children=Y_chart1),width={'size':10}),dbc.Col(html.Div(children=Y_chart2),width={'size':10})])],
                     style={'display': 'flex'}),
            html.Div(className='chart-item', children=[dbc.Row([dbc.Col(html.Div(children=Y_chart1),width={'size':10}),dbc.Col(html.Div(children=Y_chart2),width={'size':10})])],
                     style={'display': 'flex'})
